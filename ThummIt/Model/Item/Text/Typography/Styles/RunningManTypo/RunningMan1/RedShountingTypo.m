...
#import "RedShountingTypo.h"

@implementation RedShountingTypo
...
+(RedShountingTypo*) redShountingTypo{
    
    RedShountingTypo* redShountingTypo = [[self alloc] init];
    return redShountingTypo;
