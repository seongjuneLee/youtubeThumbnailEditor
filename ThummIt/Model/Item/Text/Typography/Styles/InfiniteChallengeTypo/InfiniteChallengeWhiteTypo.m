...
@implementation InfiniteChallengeWhiteTypo
...
+(InfiniteChallengeWhiteTypo*)infiniteChallengeWhiteTypo{
    
    InfiniteChallengeWhiteTypo* infiniteChallengeWhiteTypo = [[self alloc] init];
    return infiniteChallengeWhiteTypo;
