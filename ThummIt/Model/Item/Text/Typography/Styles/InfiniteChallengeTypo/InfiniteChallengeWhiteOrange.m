...
@implementation InfiniteChallengeWhiteOrange
...
+(InfiniteChallengeWhiteOrange*)infiniteChallengeWhiteOrange{
    
    InfiniteChallengeWhiteOrange* infiniteChallengeWhiteOrange = [[self alloc] init];
    return infiniteChallengeWhiteOrange;
